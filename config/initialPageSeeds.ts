import { Configuration, NavLink } from "@/prisma/generated/prisma/client";
import {
  ...
  posts: [
    {
      ...
      paragraphs: [
        ...
        {
          position: 5,
          paragraph: { id: 118, content: "Soyez nombreux, chousssss !", hyperlinks: [] },
        },
      ],
    },
  ],
...
export const INIT_CONTACT_STATE: ContactPageContent = {
  ...
  subtitle: { id: 112, content: "Informations complémentaires", hyperlinks: [] },
  files: [
    {
      id: 3,
  ...
  dates: [
    {
      ...
      image: { id: 33, alt: "La photo du groupe Désinvolts", source: "xHm4W1WpE5mNup1O8NdT.webp" },
...
export const INIT_GROUPE_STATE: GroupePageContent = {
  ...
  first_section_paragraphs: [
    ...
    { position: 1, paragraph: { id: 148, content: "Enfin... Presque...", hyperlinks: [] } },
  ],
  ...
  trombinoscope: [
    {
      ...
      position: 0,
      color: "#df6310",
      image: { id: 39, source: "8mGnlyEPgW8stC2WMjJ8.webp", alt: "La photo du groupe Désinvolts" },
      title: { id: 182, content: "Franck" },
      paragraphs: [
        {
          position: 0,
          paragraph: { id: 140, content: "Batteur / Compositeur / Auteur", hyperlinks: [] },
        },
        {
          position: 1,
          paragraph: {
    ...
    },
    {
      ...
      position: 1,
      color: "#057cc9",
      image: { id: 38, source: "HtU5hR8despK5HP2tXjp.webp", alt: "La photo du groupe Désinvolts" },
      title: { id: 181, content: "Eric" },
      paragraphs: [
        {
          position: 0,
          paragraph: { id: 137, content: "Bassiste / Compositeur", hyperlinks: [] },
        },
        {
          position: 1,
          paragraph: {
    ...
    },
    {
      ...
      position: 2,
      color: "#cc31b0",
      image: { id: 37, source: "42qoHYcYdCRz4SGpgEXy.webp", alt: "La photo du groupe Désinvolts" },
      title: { id: 180, content: "Rui" },
      paragraphs: [
        {
          position: 0,
          paragraph: { id: 134, content: "Guitariste Soliste / Compositeur", hyperlinks: [] },
        },
        {
          position: 1,
          paragraph: {
    ...
    },
    {
      ...
      position: 3,
      color: "#d62f0d",
      image: { id: 36, source: "BdTGalOog38HRoPcgQWa.webp", alt: "La photo du groupe Désinvolts" },
      title: { id: 179, content: "Laurent" },
      paragraphs: [
        {
          position: 0,
          paragraph: { id: 131, content: "Guitariste Rythmique / Choriste", hyperlinks: [] },
        },
        {
          position: 1,
          paragraph: {
    ...
    },
    {
      ...
      position: 4,
      color: "#fdaf13",
      image: { id: 35, source: "DsHxfwOJoFwcepL7sd2u.webp", alt: "La photo du groupe Désinvolts" },
      title: { id: 178, content: "Brice" },
      paragraphs: [
        { position: 0, paragraph: { id: 129, content: "Chanteur / Auteur", hyperlinks: [] } },
        {
          position: 1,
          paragraph: {
            id: 128,
...
export const INIT_MEDIA_STATE: MediasPageContent = {
  ...
  videos: [
    { id: 27, url: "https://www.youtube.com/watch?v=AUIYbPbNVcA", description: "Clip 1" },
    { id: 28, url: "https://www.youtube.com/watch?v=pbWrM1iblLI", description: "Clip 2" },
    {
      id: 29,
  ...
  windows: [
    {
      ...
      image: { id: 40, source: "j73349VhjJ919vzRkC87.webp", alt: "La photo du groupe Désinvolts" },
      video: null,
      imageId: 40,
      videoId: null,
    },
    {
      ...
      zIndex: 26,
      zIndexPriorityFactor: 0,
      image: { id: 48, source: "Bym4ksqusKz3KEdd03H4.webp", alt: "La photo du groupe Désinvolts" },
      video: null,
      imageId: 48,
      videoId: null,
    },
    {
      ...
      zIndex: 42,
      zIndexPriorityFactor: 0,
      image: { id: 45, source: "ov1GBAVIdKf8kl2tKCed.webp", alt: "La photo du groupe Désinvolts" },
      video: null,
      imageId: 45,
      videoId: null,
    },
    {
      ...
      zIndex: 47,
      zIndexPriorityFactor: 0,
      image: { id: 42, source: "mtgwmeNo79F6mE8pIRde.webp", alt: "La photo du groupe Désinvolts" },
      video: null,
      imageId: 42,
      videoId: null,
    },
    {
      ...
      zIndex: 48,
      zIndexPriorityFactor: 0,
      image: { id: 43, source: "qQLogBKA3pNfmzKemp1v.webp", alt: "La photo du groupe Désinvolts" },
      video: null,
      imageId: 43,
      videoId: null,
    },
    {
      ...
      zIndex: 49,
      zIndexPriorityFactor: 0,
      image: { id: 41, source: "rHDVBgdTJO4LcoW6rENp.webp", alt: "La photo du groupe Désinvolts" },
      video: null,
      imageId: 41,
      videoId: null,
    },
    {
      ...
      zIndex: 50,
      zIndexPriorityFactor: 0,
      image: { id: 46, source: "F465ZCZRIap7TYbDgcmw.webp", alt: "La photo du groupe Désinvolts" },
      video: null,
      imageId: 46,
      videoId: null,
    },
    {
      ...
      zIndex: 52,
      zIndexPriorityFactor: 0,
      image: { id: 44, source: "Lq8K0kKUT4wLCtJybPOZ.webp", alt: "La photo du groupe Désinvolts" },
      video: null,
      imageId: 44,
      videoId: null,
    },
    {
      ...
      zIndex: 53,
      zIndexPriorityFactor: 0,
      image: { id: 47, source: "hUxt70hDSahNf17LPvZr.webp", alt: "La photo du groupe Désinvolts" },
      video: null,
      imageId: 47,
      videoId: null,
    },
  ...
  albums: [
    {
      ...
      cover: { id: 49, source: "HEQOgf7kg6IWTLyymzYo.webp", alt: "La photo du groupe Désinvolts" },
      paragraphs: [
        {
          position: 0,
          paragraph: {
