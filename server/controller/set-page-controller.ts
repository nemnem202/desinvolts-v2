...
export default class SetPageController {
  ...
  static async setHome(data: HomePageContent) {
  ...
  static async setConnexion(data: ConnexionPageContent) {
  ...
  static async setContact(data: ContactPageContent) {
  ...
  static async setDates(data: DatesPageContent) {
  ...
  static async setGroupe(data: GroupePageContent) {
  ...
  static async setMedias(data: MediasPageContent) {
    ...
    await prisma.mediasPage.create({
      data: {
        ...
        videos: {
          create: data.videos.map((v) => ({ description: v.description, url: v.url })),
        },
        windows: {
  ...
  static async setNousEcouter(data: NousEcouterPageContent) {
  ...
  static async setConfig(data: Configuration) {
    await prisma.$transaction(async (tx) => {
      await tx.configuration.deleteMany();
      await tx.configuration.create({ data: data });
    });
  }

  static async setNavlinks(data: NavLink[]) {
    await prisma.$transaction(async (tx) => {
  ...
  static async setDefault(data: BasePageContent) {
    await this.setConfig(data.config);
    await this.setNavlinks(data.navlinks);
  }
}
