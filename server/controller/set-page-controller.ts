...
export default class SetPageController {
	...
	static async setConnexion(
		data: ConnexionPageContent | undefined,
	): Promise<ServiceResult> {
		if (!data) return { success: false, error: "Undefined data" };
	...
	static async setContact(
		data: ContactPageContent | undefined,
	): Promise<ServiceResult> {
		if (!data) return { success: false, error: "Undefined data" };
	...
	static async setDates(
		data: DatesPageContent | undefined,
	): Promise<ServiceResult> {
		if (!data) return { success: false, error: "Undefined data" };
	...
	static async setGroupe(
		data: GroupePageContent | undefined,
	): Promise<ServiceResult> {
		if (!data) return { success: false, error: "Undefined data" };
	...
	static async setMedias(
		data: MediasPageContent | undefined,
	): Promise<ServiceResult> {
		if (!data) return { success: false, error: "Undefined data" };
	...
	static async setNousEcouter(
		data: NousEcouterPageContent | undefined,
	): Promise<ServiceResult> {
		if (!data) return { success: false, error: "Undefined data" };
	...
	static async setNavlinks(
		data: NavLink[] | undefined,
	): Promise<ServiceResult> {
		if (!data) return { success: false, error: "Undefined data" };
	...
	static async setDefault(
		data: BasePageContent | undefined,
	): Promise<ServiceResult> {
		if (!data) return { success: false, error: "Undefined data" };
